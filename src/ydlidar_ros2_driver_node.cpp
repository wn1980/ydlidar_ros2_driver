...
int main(int argc, char *argv[]) {
  ...
  node->declare_parameter<int>("lidar_type", 0);
  ...
  /// sample rate
  optval = 9;
  node->declare_parameter<int>("sample_rate", 0);
  node->get_parameter("sample_rate", optval);
  laser.setlidaropt(LidarPropSampleRate, &optval, sizeof(int));
  /// abnormal count
  optval = 4;
  node->declare_parameter<int>("abnormal_check_count", 0);
